...
public class Installer {
    ...
    public void install() {
        Workflow workflow = new Workflow(objectMapper)
            ...
            .prompting(DEPARTMENT, ADMINISTRATOR).excludingCreator().with(CORRECT_POST_ACTIVITY)
            .prompting(BOARD, ADMINISTRATOR).excludingCreator().with(CORRECT_POST_ACTIVITY)
