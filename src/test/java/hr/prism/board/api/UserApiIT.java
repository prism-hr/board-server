...
//
//        Long department1id = departmentApi.createDepartment(universityId, new DepartmentDTO().setName("department1"), null).getId();
...
//            .setMemberCategories(Collections.singletonList(MemberCategory.UNDERGRADUATE_STUDENT)), null).getId();
