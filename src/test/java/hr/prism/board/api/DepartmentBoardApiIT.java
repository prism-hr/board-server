...
public class DepartmentBoardApiIT {
    ...
    public void shouldNotCreateDuplicateBoardByUpdating() {
        ...
        transactionTemplate.execute(transactionStatus -> {
            ...
            ApiTestUtil.verifyApiException(() -> departmentBoardApi.updateBoard(boardDTO1.getId(), boardDTO1), ExceptionCode.DUPLICATE_BOARD, transactionStatus);
            return null;
        });
    }
